			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form
						...
						<div class="form-group has-feedback" id="modified-address-div">
							<label for="modified-address">收货地址</label>
							<div class="input-group">
								<span class="input-group-addon"><span
										class="glyphicon glyphicon-envelope"></span></span> <input
									name="address" id="modified-address" class="form-control"
									type="address" placeholder="例如:123@123.com"
									value="${param.address}">
							</div>
							<span style="color: red; display: none;" class="tips"></span> <span
								style="display: none;"

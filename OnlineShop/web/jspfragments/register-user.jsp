			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form
						...
						<div class="form-group has-feedback" id="register-email-div">
							...
							<div class="input-group">
								<span class="input-group-addon"><span
									...
									type="email" placeholder="比如:123456@scut.edu.cn"
						...
						<div class="form-group has-feedback" id="register-address-div">
							<label for="register-address">收货地址</label>
							<div class="input-group">
								<span class="input-group-addon"><span
										class="glyphicon glyphicon-user"></span></span> <input
									id="register-address" name="account" class="form-control"
									placeholder="请输入收货地址" maxlength="50" type="text">
							</div>
...
<%--						</div>--%>
						...
						<input type="hidden" name="orgUrl"
							...
							data-toggle="modal" data-dismiss="modal" data-target="#login">已有账号？赶快点我去登录吧</a>

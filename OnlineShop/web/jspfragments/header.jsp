	...
	<div class="container">
		<div class="navbar-header">
			...
			<a href="${pageContext.request.contextPath}/index.jsp"
				...
				src="${pageContext.request.contextPath}/images/logo/logo.png"></a>
			</a>
		</div>
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
						...
						<li class="divider"></li>
						<li><a
							href="${pageContext.request.contextPath}/servlet/searchItemPageServlet?type=宋制汉服">宋制汉服</a></li>
						<li class="divider"></li>
						<li><a
							href="${pageContext.request.contextPath}/servlet/searchItemPageServlet?type=唐制汉服">唐制汉服</a></li>
						<li class="divider"></li>
						<li><a
							href="${pageContext.request.contextPath}/servlet/searchItemPageServlet?type=秦汉制汉服">秦汉制汉服</a></li>
					</ul></li>
			</ul>
		</div>

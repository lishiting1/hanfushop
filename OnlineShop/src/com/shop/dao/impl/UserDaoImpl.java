...
public class UserDaoImpl implements IUserDao {
	...
	public void insert(User user) throws SQLException {
		...
		String sql = "insert into `user`(account, password, tel, email,address) values(?, ?, ?, ?, ?)";
		Object[] params = { user.getAccount(), user.getPassword(), user.getTel(), user.getEmail() ,user.getAddress()};
	...
	public void update(User user) throws SQLException {
		QueryRunner qr = new QueryRunner();
		String sql = "update `user` set password=?,tel=? ,email=? ,address=? where account=?";
		Object params[] = { user.getPassword(), user.getTel(), user.getEmail(), user.getAddress(),user.getAccount() };
